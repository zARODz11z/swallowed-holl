Shader "Hidden/.poiyomi/• Poiyomi Toon •/Trophy-3b082ab0"
{
    Properties
    {
...
#define PROP_MAINEMISSIONSTRENGTH 2.57
#define PROP_BUMPMAP
#define PROP_BUMPMAPUV 0
#define PROP_BUMPSCALE 4.53
...
#define PROP_SPECULARTOONEND 0.855
