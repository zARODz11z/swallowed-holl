    ...
    float4 frag(v2f i, uint facing: SV_IsFrontFace): SV_Target
    {
        ...
        **********************************************************************/
            ...
            finalEmission += finalColorBeforeLighting.rgb * float(0.67) * albedo.a;
        ...
        **********************************************************************/
            ...
            #ifdef POI_SPECULAR
                meta.SpecularColor = poiLight.color.rgb * float4(0,0.1653383,0.003723431,1).rgb * lerp(1, albedo.rgb, float(0)) * float4(0,0.1653383,0.003723431,1).a;
            #else
