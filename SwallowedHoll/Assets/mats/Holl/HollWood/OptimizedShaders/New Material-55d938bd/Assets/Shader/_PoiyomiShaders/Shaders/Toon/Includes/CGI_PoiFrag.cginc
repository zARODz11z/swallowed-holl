    ...
    float4 frag(v2f i, uint facing: SV_IsFrontFace): SV_Target
    {
        ...
        **********************************************************************/
            ...
            finalEmission += finalColorBeforeLighting.rgb * float(3.17) * albedo.a;
        ...
        **********************************************************************/
            ...
            #ifdef POI_SPECULAR
                meta.SpecularColor = poiLight.color.rgb * float4(1,1,1,1).rgb * lerp(1, albedo.rgb, float(0.39)) * float4(1,1,1,1).a;
            #else
